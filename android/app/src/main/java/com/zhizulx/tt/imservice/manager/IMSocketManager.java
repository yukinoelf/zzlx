...
import com.zhizulx.tt.imservice.callback.ListenerQueue;
import com.zhizulx.tt.imservice.callback.Packetlistener;
import com.zhizulx.tt.imservice.event.SocketEvent;
import com.zhizulx.tt.imservice.network.MsgServerHandler;
import com.zhizulx.tt.imservice.network.SocketThread;
import com.zhizulx.tt.protobuf.IMBaseDefine;
import com.zhizulx.tt.protobuf.base.DataBuffer;
import com.zhizulx.tt.protobuf.base.DefaultHeader;
...
public class IMSocketManager extends IMManager {
    ...
    public void sendRequest(GeneratedMessageLite requset,int sid,int cid,Packetlistener packetlistener){
        ...
        try{
            //组装包头 header
            com.zhizulx.tt.protobuf.base.Header header = new DefaultHeader(sid, cid);
    ...
    public void packetDispatch(ChannelBuffer channelBuffer){
        ...
        com.zhizulx.tt.protobuf.base.Header header = new com.zhizulx.tt.protobuf.base.Header();
