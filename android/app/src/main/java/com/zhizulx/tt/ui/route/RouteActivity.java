package com.zhizulx.tt.ui.route;
...
OnMarkerClickListener, OnInfoWindowClickListener, InfoWindowAdapter, OnRouteSearchListener {
	...
	protected void onCreate(Bundle bundle) {
		...
		topBar = (LinearLayout) findViewById(R.id.route_activity_top_bar);
		...
		init();
		setfromandtoMarker();
		MapRoute mapRoute = (MapRoute)getIntent().getSerializableExtra("map_point");
		...
		ImageView back = (ImageView) findViewById(R.id.route_back);
