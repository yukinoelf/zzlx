...
private:
    ...
    void _HandleCreateCollectRouteRequest(CImPdu* pPdu);
    void _HandleDeleteCollectRouteRequest(CImPdu* pPdu);
    void _HandleQueryCollectRouteRequest(CImPdu* pPdu);
    void _HandleInfoModifyRequest(CImPdu* pPdu);
private:
