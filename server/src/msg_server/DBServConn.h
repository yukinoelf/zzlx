...
private:
    ...
    void _HandleUpdateRadomRouteResponse(CImPdu* pPdu);
    void _HandleNewCreateTravelResponse(CImPdu* pPdu);
    ...
    void _HandleCreateCollectRouteResponse(CImPdu* pPdu);
    void _HandleDeleteCollectRouteResponse(CImPdu* pPdu);
    void _HandleQueryCollectRouteResponse(CImPdu* pPdu);
    void _HandleInfoModifyRsp(CImPdu* pPdu);
private:
	bool 		m_bOpen;
	uint32_t	m_serv_idx;
};
