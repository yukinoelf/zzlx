...
enum BuddyListCmdID {
  ...
  CID_BUDDY_LIST_TRAVEL_CREATE_REQUEST = 593,
  CID_BUDDY_LIST_TRAVEL_CREATE_RESPONSE = 594,
  CID_BUDDY_LIST_TRAVEL_DELETE_REQUEST = 595,
  CID_BUDDY_LIST_TRAVEL_DELETE_RESPONSE = 596,
  CID_BUDDY_LIST_TRAVEL_UPDATE_REQUEST = 597,
  CID_BUDDY_LIST_TRAVEL_UPDATE_RESPONSE = 598,
  CID_BUDDY_LIST_TRAVEL_QUERY_REQUEST = 599,
  CID_BUDDY_LIST_TRAVEL_QUERY_RESPONSE = 600,
  CID_BUDDY_LIST_TRAVEL_TRANSPORT_TOOL_REQUEST = 601,
  CID_BUDDY_LIST_TRAVEL_TRANSPORT_TOOL_RESPONSE = 602,
  CID_BUDDY_LIST_TRAVEL_GET_SCENIC_HOTEL_REQUEST = 603,
  CID_BUDDY_LIST_TRAVEL_GET_SCENIC_HOTEL_RESPONSE = 604,
  CID_BUDDY_LIST_RADOM_ROUTE_QUERY_REQUEST = 605,
  CID_BUDDY_LIST_RADOM_ROUTE_QUERY_RESPONSE = 606,
  CID_BUDDY_LIST_RADOM_ROUTE_UPDATE_REQUEST = 607,
  CID_BUDDY_LIST_RADOM_ROUTE_UPDATE_RESPONSE = 608,
  CID_BUDDY_LIST_NEW_TRAVEL_CREATE_REQUEST = 609,
  CID_BUDDY_LIST_NEW_TRAVEL_CREATE_RESPONSE = 610,
  CID_BUDDY_LIST_NEW_CREATE_COLLECT_ROUTE_REQUEST = 611,
  CID_BUDDY_LIST_NEW_CREATE_COLLECT_ROUTE_RESPONSE = 612,
  CID_BUDDY_LIST_NEW_DELETE_COLLECT_ROUTE_REQUEST = 613,
  CID_BUDDY_LIST_NEW_DELETE_COLLECT_ROUTE_RESPONSE = 614,
  CID_BUDDY_LIST_NEW_QUERY_COLLECT_ROUTE_REQUEST = 615,
  CID_BUDDY_LIST_NEW_QUERY_COLLECT_ROUTE_RESPONSE = 616,
  CID_BUDDY_INFO_MODIFY_REQUEST = 617,
  CID_BUDDY_INFO_MODIFY_RESPONSE = 618
};
...
const BuddyListCmdID BuddyListCmdID_MAX = CID_BUDDY_INFO_MODIFY_RESPONSE;
...
enum ResultType {
  ...
  REFUSE_REASON_UNDEFINE_REQUEST = 8,
  REFUSE_REASON_DB_OP_FAILED = 9
};
bool ResultType_IsValid(int value);
const ResultType ResultType_MIN = REFUSE_REASON_NONE;
const ResultType ResultType_MAX = REFUSE_REASON_DB_OP_FAILED;
